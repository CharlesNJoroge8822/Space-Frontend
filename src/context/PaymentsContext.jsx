...
const checkPaymentStatus = useCallback(async (transactionId) => {
    try {
        const response = await fetch(`https://space-backend-10.onrender.com/payments/${transactionId}`);
    ...
    const deletePayment = async (id) => {
        try {
            ...
            const response = await fetch(`https://space-backend-10.onrender.com/payments/${id}`, {
                method: "DELETE",
                headers: {
