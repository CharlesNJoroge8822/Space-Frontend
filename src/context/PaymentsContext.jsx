...
const stkPush = useCallback(async (phoneNumber, amount, bookingId) => {
    ...
    try {
        ...
        const response = await fetch("https://space-backend-77u4.onrender.com/payments", {
            method: "POST",
...
const checkPaymentStatus = useCallback(async (transactionId) => {
    try {
        const response = await fetch(`https://space-backend-77u4.onrender.com/payments/${transactionId}`);
    ...
    const deletePayment = async (id) => {
        try {
            ...
            const response = await fetch(`https://space-backend-77u4.onrender.com/payments/${id}`, {
                method: "DELETE",
                headers: {
