...
export const SpaceProvider = ({ children }) => {
    ...
    const fetchSpaces = useCallback(async () => {
        setLoading(true);
        try {
            const response = await fetch("https://space-backend-10.onrender.com/spaces", {
                method: "GET",
    ...
    const updateSpace = async (spaceId, updatedData) => {
        ...
        try {
            const response = await fetch(`https://space-backend-10.onrender.com/spaces/${spaceId}`, {
                method: "PATCH",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${authToken}`,
    ...
    const processPayment = async (bookingId, paymentData) => {
        try {
            ...
            const response = await fetch("https://space-backend-10.onrender.com/process-payment", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
