...
const fetchAllUsers = async () => {
    ...
    try {
        ...
        const response = await fetch("https://space-backend-77u4.onrender.com/users", {
            method: "GET",
            headers: {
    ...
    const googleLogin = async (email) => {
        ...
        try {
            const response = await fetch("https://space-backend-77u4.onrender.com/googlelogin", {
                method: "POST",
            ...
            if (data.access_token) {
                ...
                const userResponse = await fetch("https://space-backend-77u4.onrender.com/current_user", {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json",
...
const login = async (email, password, role) => {
    ...
    try {
        const response = await fetch("https://space-backend-77u4.onrender.com/login", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
...
const updateProfile = async (userId, updatedData) => {
    ...
    try {
        ...
        const response = await fetch(`https://space-backend-77u4.onrender.com/users/${userId}`, {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${token}`,
    ...
    const logout = () => {
        ...
        fetch("https://space-backend-77u4.onrender.com/logout", {
            method: "DELETE",
            headers: {
                "Content-type": "application/json",
