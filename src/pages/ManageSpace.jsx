...
const ManageSpace = () => {
    ...
    return (
        <div className="manage-space" style={{ padding: "20px", margin: "0 auto", maxWidth: "1400px", minHeight: "100vh", }}>
            ...
            {/* Space Form */}
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 p-6 bg-white shadow-lg rounded-lg">
            ...
            {/* Loading */}
            {loading ? (
                <p className="text-center text-gray-500 mt-6">Loading spaces...</p>
            ) : (
                        ...
                        spaces.map((space) => (
                            <div key={space.id} className="p-4 shadow-lg rounded-lg border bg-white">
                                <img
                                    src={
                                        space.images &&
                                        (space.images.startsWith("data:image") || space.images.startsWith("http"))
                                            ? space.images
                                    ...
                                    onError={(e) => {
                                        e.target.src = "https://dummyimage.com/400x300/000/fff&text=No+Image";
                                    }}
                                />
                                <div className="p-4">
                                    ...
                                    <p>
                                        <strong>Location:</strong> {space.location || "Unknown"}
                                    </p>
                                    <p>
                                        <strong>Price per Hour:</strong> ${space.price_per_hour || 0}
                                    </p>
                                    <p>
                                        <strong>Price per Day:</strong> ${space.price_per_day || 0}
                                    </p>
                                    <p>
                                        <strong>Availability:</strong>{" "}
                                        <span className={`font-bold ${space.availability ? "text-green-700" : "text-red-700"}`}>
                                            {space.availability ? "Available" : "Booked"}
                                        </span>
                                    </p>
                                    <div className="flex justify-between mt-4">
                                        <button
                                            onClick={() => updateSpace(space.id, { availability: !space.availability })}
